...
from NetxTest import test_with_netx
import sys
sys.path.append("..")
...
def objective(rank, world_size, DATASET_PATH, true_rate):
    ...
    print("Testing with netx...")
    test_with_netx(net_path=f"{OUTPUT_PATH}/network.net", dataset_path=DATASET_PATH, sample_length=1000)
