...
def main():
    dataset_path = "/media/george/T7 Shield/Neuromorphic Data/Ao/bigdataset/"
    output_path = "/media/george/T7 Shield/Neuromorphic Data/George/all_speeds_sorted/"
    try:
    ...
    # Find all depths
    depths = list(set([d.split("_")[-3] for d in speed_dirs]))
    ...
    for d in tex_dirs:
        ...
        for s in speed_d:
            ...
            for f in files:
                ...
                output_name = f"{depth}-{trial}-{texture}-{speed}.pickle"
